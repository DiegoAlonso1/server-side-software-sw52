...
@mytag
Scenario: 1 Initialize some Group Intances
...
#2 - Update a group
Scenario: The user wants to update a group
...
#3 - Get all groups
Scenario: The administrator wants to see all groups
...
#4 - Get group by id
Scenario: The user wants to see his group data 
...
Scenario: The user wants to see the members list of his group
...
#6 - Delete a group
Scenario: The user wants to delete his group

...
#line hidden
            ...
            else
            {
                ...
                table42.AddRow(new string[] {
                            "2"});
#line 8
 testRunner.When("session required attributes provided to initialize instance", ((string)(null)), table42, "When ");
#line hidden
#line 12
...
#line 21
 testRunner.When("the administrator goes to Functionality Usage Page on session with id 5, the sess" +
                        "ion stadistics list should return", ((string)(null)), table43, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 32
 testRunner.When("the user uses the functionality with id 1 in the session with id 1, session stadi" +
                        "stics details should be", ((string)(null)), table44, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }

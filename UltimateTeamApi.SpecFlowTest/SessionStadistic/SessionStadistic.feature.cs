...
#line hidden
            ...
            else
            {
                ...
                table31.AddRow(new string[] {
                            "2"});
#line 8
 testRunner.When("session required attributes provided to initialize instance", ((string)(null)), table31, "When ");
#line hidden
#line 12
...
#line 21
 testRunner.When("the administrator goes to Functionality Usage Page on session with id 5, the sess" +
                        "ion stadistics list should return", ((string)(null)), table32, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }
...
#line 32
 testRunner.When("the user uses the functionality with id 1 in the session with id 1, session stadi" +
                        "stics details should be", ((string)(null)), table33, "When ");
#line hidden
            }
            this.ScenarioCleanup();
        }

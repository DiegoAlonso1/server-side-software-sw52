...
Scenario: 0. Initialize some Friendship Intances
	When persons required attributes provided to initialize instances
		...
		| Lionel   | Messi     | ElMesias      | leo@barzabestclub.com  | 1212-12-12 | 1219-12-12     | null			 | 1			   |
		| Fernando | Firulais  | FernanElCrack | fernan@elcrack.es      | 1999-05-21 | 2020-05-20     | null			 | 1               |
...
Scenario: 1. The person wants to see his friend list
	...
	Then the friend list of person with Id 1 should be
		...
		| 4  | Lionel | Messi     | ElMesias  | leo@barzabestclub.com | 1212-12-12 | 1219-12-12     | null		   | 1			     |

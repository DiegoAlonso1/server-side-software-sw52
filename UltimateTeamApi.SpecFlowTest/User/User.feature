...
#2 - Update an user
Scenario: 2. The user wants to update their data profile
	When the user with id 5 complete the form with required fields and click the Update button
		| Name	   | LastName | UserName      | Email             | Password        | Birthdate           | LastConnection          | ProfilePicture   | AdministratorId |
		| Fernando | Firulais | FernanElCrack | fernan@elcrack.es | NuevaContraseña | 1999-05-21T00:00:00 | 2020-05-20T00:00:00     | null			   | 1               |


#3 - Get all users
Scenario: 3. The administrator wants to see all users
...
#5 - Get user by email
Scenario: 5. The user wants to send a friend request
	When the user send a friend request to email "lulu@gmail.com"
	Then the receiving user details should be 
		| Id | Name     | LastName  | UserName      | Email                 | Password        | Birthdate           | LastConnection          | ProfilePicture | AdministratorId |
		| 2  | Lucia    | Revollar  | Lulu          | lulu@gmail.com        | CrusUpc#3       | 2003-01-09T00:00:00 | 2020-01-20T00:00:00     | null           | 1               |


#6 - Delete a user
Scenario: 6. The user wants to delete his account
